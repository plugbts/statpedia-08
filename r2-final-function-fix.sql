-- Complete R2 Function Fix - All Issues Resolved
-- Run this to fix both type mismatches and ambiguous column references

-- Fix 1: get_r2_usage_vs_plan function (type mismatch fix)
...
-- Fix 2: get_r2_usage_stats function (ambiguous column fix)
