-- 0006: Extend v_props_list to include team/opponent logo URLs
...
SELECT
  ...
  COALESCE(pes.ev_percent, pa.ev_percent) AS ev_percent,
  pes.streak_l5,
  pes.rating,
  ...
  g.game_date,
  -- Logos with fallback to ESPN CDN patterns
  COALESCE(
    t.logo_url,
    CASE l.abbreviation
