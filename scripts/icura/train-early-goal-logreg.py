...
FEATURES = [
  ...
  "ref_penalties_first_period_avg",
  "ref_penalties_first10_avg",
  "ref_minors_vs_majors_ratio",
  "ref_home_away_penalty_bias",
  # NEW G1F10 FEATURES - Shift-level matchup modeling
  "home_top_line_xgf_first10_last20",
  "home_top_line_xga_first10_last20",
  "home_top_line_rush_rate_first10_last20",
  "home_top_line_hd_rate_first10_last20",
  "home_top_pair_xga_suppression_first10_last20",
  "away_top_line_xgf_first10_last20",
  "away_top_line_xga_first10_last20",
  "away_top_line_rush_rate_first10_last20",
  "away_top_line_hd_rate_first10_last20",
  "away_top_pair_xga_suppression_first10_last20",
  # NEW G1F10 FEATURES - Penalty volatility
  "home_draw_penalty_rate_first10",
  "home_take_penalty_rate_first10",
  "away_draw_penalty_rate_first10",
  "away_take_penalty_rate_first10",
  "penalty_volatility_index",
  "ref_team_interaction_home",
  "ref_team_interaction_away",
  # NEW G1F10 FEATURES - Travel + fatigue interactions
  "home_b2b_travel::int",
  "away_b2b_travel::int",
  "home_3in4_travel::int",
  "away_3in4_travel::int",
  "west_to_east_travel::int",
  "early_start_time::int",
  # NEW G1F10 FEATURES - Goalie-specific early-game tendencies
  "home_goalie_first_shot_save_pct",
  "home_goalie_first_3_shots_save_pct",
  "home_goalie_rebound_rate_first10",
  "home_goalie_rush_save_pct_first10",
  "home_goalie_screened_save_pct_first10",
  "away_goalie_first_shot_save_pct",
  "away_goalie_first_3_shots_save_pct",
  "away_goalie_rebound_rate_first10",
  "away_goalie_rush_save_pct_first10",
  "away_goalie_screened_save_pct_first10",
