-- Fix the refresh_enrichment function to use broader date range
-- The game logs are from 2024-2025, not recent dates
...
BEGIN
    ...
    WHERE pgl.game_date >= '2024-01-01'; -- Use broader date range to include all data
