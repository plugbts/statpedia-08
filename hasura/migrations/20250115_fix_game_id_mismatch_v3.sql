...
-- Use correct league case and create missing games

-- 1. Create missing games for orphaned logs
...
-- 2. Update the mapping table with the new games
...
-- 3. Update player_game_logs to use canonical IDs
