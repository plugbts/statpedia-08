-- Complete R2 Function Type Fix
-- Run this to fix all type mismatches in R2 functions

-- Fix 1: get_r2_usage_vs_plan function
...
-- Fix 2: get_r2_usage_stats function (ensure consistent types)
