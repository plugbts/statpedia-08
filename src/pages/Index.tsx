  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        {activeTab !== 'dashboard' && activeTab !== 'player-props' && activeTab !== 'insights' && activeTab !== 'bet-tracking' && activeTab !== 'social' && activeTab !== 'moneyline-props' && activeTab !== 'strikeout-center' && activeTab !== 'most-likely' && activeTab !== 'sync-test' && (
