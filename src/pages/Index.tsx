...
const Index = () => {
      ...
      <div className="space-y-6">
        ...
        {realPredictions.filter((p) => p.confidence >= 80).length === 0 && (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <Button onClick={loadRealPredictions} className="mt-4" disabled={isLoadingPredictions}>
  ...
  const getTodaysTopPicks = () => {
    ...
    let filteredPredictions = allPredictions
      .filter((prediction) => {
        ...
        return (
          predictionSport === selectedSportLower ||
  ...
  const loadRealPredictions = async () => {
    ...
    try {
      // Get predictions from games service
        ...
        <div className="relative p-8 lg:p-12">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl lg:text-6xl font-display font-bold text-foreground mb-4 animate-fade-in">
              ...
              <br />
              <span
                className="bg-gradient-primary bg-clip-text text-transparent animate-scale-in display-name-gradient"
            ...
            <p
              className="text-xl text-muted-foreground mb-6 animate-slide-up font-body"
              style={{ animationDelay: "150ms" }}
            >
              AI-powered predictions with 73.4% accuracy across 50,000+ backtested games. Experience
        ...
        <div id="todays-picks-section" className="animate-fade-in">
          <TodaysPicksCarousel
            ...
            sport={
              ...
              allPredictions.filter((p) => p.sport === selectedSport).length === 0
                ? "ALL SPORTS"
                : selectedSport
            }
          />
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <div
                    className={`w-2 h-2 rounded-full ${Notification.permission === "granted" ? "bg-green-500" : "bg-yellow-500"}`}
                  ></div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {alert.condition === "above" ? "Above" : "Below"} {alert.odds} -{" "}
      ...
      <div className="space-y-6 animate-fade-in" style={{ animationDelay: "300ms" }}>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Showing {startIndex + 1}-{Math.min(endIndex, allPredictions.length)} of{" "}
        ...
        {isLoadingPredictions ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground mb-4">
              No predictions available for {selectedSport.toUpperCase()}
            </p>
  ...
  const renderSyncTest = () => (
    <div className="space-y-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-foreground mb-4">Sync Integration Test</h1>
        <p className="text-muted-foreground">
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      />
      <main
        className={`${activeTab === "player-props" ? "w-full px-0" : "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"} py-8 relative z-10`}
      >
        {/* Header Banner Ad */}
