...
export const teamAbbrMap: Record<string, string> = {
  ...
  Pirates: "PIT",
  Padres: "SD",
  "SF Giants": "SF", // Changed from 'Giants' to avoid NFL/MLB conflict
  Mariners: "SEA",
  "STL Cardinals": "STL", // Changed from 'Cardinals' to avoid NFL/MLB conflict
  Rays: "TB",
  "TEX Rangers": "TEX", // Changed from 'Rangers' to avoid NHL conflict
  "Blue Jays": "TOR",
  BlueJays: "TOR",
  Nationals: "WSH",
  ...
  "Blue Jackets": "CBJ",
  BlueJackets: "CBJ",
  "DAL Stars": "DAL", // Changed from 'Stars' to avoid NHL/DAL ambiguity
  "Red Wings": "DET",
  RedWings: "DET",
  Oilers: "EDM",
  "FLA Panthers": "FLA", // Changed from 'Panthers' to avoid NFL/FLA conflict
  "LA Kings": "LAK", // Changed from 'Kings' to avoid NBA/NHL conflict
  Wild: "MIN",
  Canadiens: "MTL",
  Habs: "MTL",
  Predators: "NSH",
  ...
  Devils: "NJD",
  Islanders: "NYI",
  "NYR Rangers": "NYR", // Changed from 'Rangers' to avoid TEX Rangers conflict
  Senators: "OTT",
  Sens: "OTT",
  Flyers: "PHI",
  Penguins: "PIT",
  ...
  Capitals: "WSH",
  Caps: "WSH",
  "WPG Jets": "WPG", // Changed from 'Jets' to avoid NYJ Jets conflict
};
