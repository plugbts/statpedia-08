...
class EmailVerificationService {
   ...
   */
  async sendVerificationCode(email: string, purpose: 'password_change' | 'email_change' | 'security'): Promise<{ success: boolean; message: string }> {
    try {
   ...
   */
  async verifyCode(email: string, code: string, purpose: 'password_change' | 'email_change' | 'security'): Promise<{ success: boolean; message: string }> {
    try {
