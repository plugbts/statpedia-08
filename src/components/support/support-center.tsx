...
type SupportCenterProps = Record<string, unknown>;
  ...
  const faqData: FAQItem[] = [
    {
      ...
      answer:
        'You can upgrade your subscription by clicking on the "Plans" tab in the navigation bar or by clicking "Upgrade to Pro" on any blurred content. Choose your desired plan and complete the payment process.',
    ...
    },
    {
      ...
      answer:
        "The free plan includes: viewing total predictions count, seeing overall win rate, access to wins summary, viewing up to 2 predictions, and seeing prediction accuracy up to 65%. All detailed analysis is blurred.",
      category: "Subscription",
    ...
    },
    {
      ...
      answer:
        "Click on any player prop card and then click the blue chart icon (📊) to open the comprehensive player analysis overlay. This includes injury reports, advanced stats, and matchup analysis.",
      category: "Features",
    ...
    },
    {
      ...
      answer:
        "Statpedia supports NFL, NBA, MLB, NHL, NCAAF, NCAAB, UFC, and Soccer. You can filter by sport using the sports filter in the navigation bar.",
      category: "Sports",
    ...
    },
    {
      ...
      answer:
        "Go to Settings (click your profile icon → Settings) and update your display name. Note: You can only change your name twice every 30 days.",
      category: "Account",
    ...
    },
    {
      ...
      answer:
        'Type "live agent" or "agent" in the chat, and you\'ll be given the option to create a support ticket. Our team will respond via email within 24 hours.',
      category: "Support",
    ...
    },
    {
      ...
      answer:
        "Pro includes all predictions, player prop analysis, statistical insights, filtering, real-time updates, and priority support. Premium adds exclusive predictions, AI insights, custom models, API access, and dedicated account management.",
      category: "Subscription",
    ...
    },
    {
      ...
      answer:
        'Go to Settings → Subscription tab and click "Cancel Auto-Renewal". Your subscription will remain active until the end of your current billing period.',
      category: "Subscription",
      ...
      setMessages([
        {
          ...
          type: "ai",
          content:
            "Hello! I'm Statpedia's AI assistant. How can I help you today? You can ask me about our features, subscription plans, or type \"live agent\" to speak with a human representative.",
          timestamp: new Date(),
          ...
          <TabsContent value="faq" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Find answers to common questions about Statpedia</CardDescription>
              </CardHeader>
              <CardContent>
                {/* Search */}
