...
export const ParlayGen: React.FC = () => {
  ...
  const hasPremiumAccess =
    userRole === "owner" || userSubscription === "premium" || userRole === "admin";
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Parlay Gen is available with Premium subscription</CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground">
              Unlock AI-powered parlay generation with advanced predictions and customizable
              filters.
            </p>
