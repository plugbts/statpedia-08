      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Advanced Sports Analytics Platform</p>
          </div>
        </div>
          ...
          <CardHeader>
            ...
            >
              ...
              <TabsContent value="login" className="space-y-2 mt-4">
                ...
                <CardDescription>Sign in to access your Statpedia dashboard</CardDescription>
              </TabsContent>

              <TabsContent value="signup" className="space-y-2 mt-4">
                <CardTitle>Create Account</CardTitle>
                <CardDescription>Join thousands of successful sports bettors</CardDescription>
              </TabsContent>
            </Tabs>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {authMode === "signup" && (
              <Alert className="border-warning bg-warning/10">
                ...
                <AlertDescription>
                  After signup, you'll choose a subscription plan to access all predictions and
                  analysis features.
                </AlertDescription>
              </Alert>
            )}
