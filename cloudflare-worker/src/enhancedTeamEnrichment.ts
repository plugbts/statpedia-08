...
export function enrichTeams(
  ...
  // NOTE: Removed duplicate check for prop.playerTeamID (already checked above)
  // Try to match player's team ID to home/away teams if we still don't have a team
