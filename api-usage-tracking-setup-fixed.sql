-- SportsGameOdds API Usage Tracking System - CORRECTED VERSION
-- Fixed parameter ordering for functions with default values
...
-- Step 5: Create function to log API usage (FIXED PARAMETER ORDER)
...
-- Step 6: Create function to get API usage statistics (FIXED PARAMETER ORDER)
...
-- Step 7: Create function to get API usage vs plan (FIXED PARAMETER ORDER)
