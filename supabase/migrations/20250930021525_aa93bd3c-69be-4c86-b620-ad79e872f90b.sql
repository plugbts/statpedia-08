...
-- 2. Create profile access audit table (if not exists)
...
-- 5. Add RESTRICTIVE policy as safety net (applies with AND logic)
...
-- 6. Create trigger to prevent non-admins from changing subscription tier
...
-- 7. Create secure view for friend profiles (hides sensitive financial data)
