-- Debug view to include UNK values for troubleshooting
...
WHERE p.league IS NOT NULL
  ...
  -- REMOVED: AND p.team IS NOT NULL AND p.team != 'UNK'
  -- REMOVED: AND p.opponent IS NOT NULL AND p.opponent != 'UNK'
