...
--------------------------------*/
function calculateHitRate(data: any[], direction: string, gamesLimit?: number): { hits: number, total: number, hitRate: number } {
...
function calculateStreak(data: any[], direction: string): { currentStreak: number, longestStreak: number, streakDirection: string } {
  let currentStreak = 0
  let longestStreak = 0
