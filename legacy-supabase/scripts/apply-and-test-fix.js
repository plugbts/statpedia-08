    ...
    if (applyError) {
        ...
        rows: [
          {
            ...
            conflict_key:
              "TEST_COLUMN_FIX_1|2025-01-10|test_column_fix_prop|SportsGameOdds|nfl|2025",
          },
        ],
      });
      ...
      if (testError) {
        ...
        if (testError.message.includes("last_updated")) {
          console.log(
            "💡 The function still references last_updated. You need to run the fix-rpc-column-name.sql script in your Supabase SQL Editor.",
          );
        }
      } else {
