...
const supabaseKey =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJmZHJpZm5zZm9icWx6b3JjZXNuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzU4NDQ0NzAsImV4cCI6MjA1MTQyMDQ3MH0.t4kXqJYkF4J8Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q";
...
async function testNewView() {
  ...
  try {
    ...
    const { data, error } = await supabase.from("player_props_fixed").select("*").limit(5);
